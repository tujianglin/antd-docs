<template>
  <div>
    ...
    <Input addon-before="1" addon-after="2" :style="{ width: 100 }" />
...
import { AutoComplete, Button, Cascader, DatePicker, Input, InputNumber, Mentions, Radio, Select, TimePicker, TreeSelect, Typography } from 'antd-v';
