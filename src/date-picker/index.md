...
<code src="./demo/range-picker.vue">范围选择器</code>
<code src="./demo/multiple.vue" version="5.14.0">多选</code>
<code src="./demo/needConfirm.vue" version="5.14.0">选择确认</code>
<code src="./demo/switchable.vue">切换不同的选择器</code>
<code src="./demo/format.vue">日期格式</code>
<code src="./demo/time.vue">日期时间选择</code>
<code src="./demo/mask.vue" version="5.14.0">格式对齐</code>
<code src="./demo/date-range.vue" version="5.14.0">日期限定范围</code>
<code src="./demo/disabled.vue">禁用</code>
<code src="./demo/disabled-date.vue">不可选择日期和时间</code>
<code src="./demo/allow-empty.vue">允许留空</code>
<code src="./demo/select-in-range.vue">选择不超过一定的范围</code>
<code src="./demo/preset-ranges.vue">预设范围</code>
<code src="./demo/extra-footer.vue">额外的页脚</code>
<code src="./demo/size.vue">三种大小</code>
<code src="./demo/cell-render.vue">定制单元格</code>
<code src="./demo/components.vue" version="5.14.0">定制面板</code>
<code src="./demo/external-panel.vue">外部使用面板</code>
...
<code src="./demo/suffix.vue">前后缀</code> 
