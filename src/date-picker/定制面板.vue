...
import type { SharedPanelProps } from 'antd-v/date-picker/interface';
...
const MyDatePanel = defineComponent({
  setup(_, { attrs }) {
    const { value, onSelect, onHover } = toRefs(reactiveComputed(() => attrs as unknown as SharedPanelProps));
