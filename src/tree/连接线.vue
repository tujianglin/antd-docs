...
const showLeafIcon = ref<VueNode | boolean>(true);

const onSelect = (selectedKeys: VueKey[], info: any) => {
...
<template>
  <div>
    <div :style="{ marginBottom: '16px' }">
      showLine: <Switch v-model:checked="showLine" />
      <br />
      <br />
      showIcon: <Switch v-model:checked="showIcon" />
      <br />
      <br />
      showLeafIcon:
      <Select
