...
<!-- prettier-ignore -->
<code src="./demo/basic.vue">语法糖</code>
<code src="./demo/color-variant.vue" version="5.21.0">颜色与变体</code>
<code src="./demo/icon.vue">按钮图标</code>
<code src="./demo/icon-position.vue" version="5.17.0">按钮图标位置</code>
<code src="./demo/size.vue">按钮尺寸</code>
<code src="./demo/disabled.vue">不可用状态</code>
<code src="./demo/loading.vue">加载中状态</code>
<code src="./demo/multiple.vue">多个按钮组合</code>
<code src="./demo/ghost.vue">幽灵按钮</code>
<code src="./demo/danger.vue">危险按钮</code>
<code src="./demo/block.vue">Block 按钮</code>
<code src="./demo/chinese-space.vue" version="5.17.0">移除两个汉字之间的空格</code>
